...
procedure Cargar_Imagenes is 
      ...
      Image ("imgs/consumo.bmp")     
         );


      Rutas_imagenes_naturaleza: Vector_Image_type:=
      (
      Image ("imgs/31.bmp"),
      Image ("imgs/32.bmp"),
      Image ("imgs/33.bmp"),
  ...
  begin
   ...
   if not naturaleza then
      ...
      for I in 21..30 loop
       ...
       for I in 1..10 loop
       if Valid(Rutas_Imagenes_Naturaleza(I)) then
            Draw_Image(Dibujo_Defensor_Romano(I),(0,0),(Width(Rutas_Imagenes_Naturaleza(I)),Height(Rutas_Imagenes_Naturaleza(I))),Rutas_Imagenes_Naturaleza(I));
            Draw_Image(Dibujo_Defensor_Galo(I),(0,0),(Width(Rutas_Imagenes_Naturaleza(11)),Height(Rutas_Imagenes_Naturaleza(11))),Rutas_Imagenes_Naturaleza(11));
            Draw_Image(Dibujo_Defensor_Germano(I),(0,0),(Width(Rutas_Imagenes_Naturaleza(11)),Height(Rutas_Imagenes_Naturaleza(11))),Rutas_Imagenes_Naturaleza(11));
       end if;
       end loop;
  end if;     
   ...
   Draw_Image(Dibujo_Perdidas(17),(0,0),(Width(Rutas_Imagenes(35))),Height(Rutas_Imagenes(35)),Rutas_Imagenes(35));
   Draw_Image(Dibujo_Perdidas(18),(0,0),(Width(Rutas_Imagenes(35))),Height(Rutas_Imagenes(35)),Rutas_Imagenes(35));
